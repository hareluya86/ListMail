...
***************************************/
	...
	function send($to_name, $to_addr, $from_name, $from_addr, $subject = '', $headers = ''){
		...
		if(!isset($xtra_headers))
			$xtra_headers = array();
     $xheads = implode(CRLF, $this->headers);
 /*
    echo "CRLF=".str_replace("\r","\\r",str_replace("\n","\\n",CRLF));

    $xheads2 = str_replace("\r","\\r",$xheads);
     $xheads2 = str_replace("\n","\\n",$xheads2);
    echo "xheads2=$xheads2.."; */
		return mail($to, $subject, $this->output, 'From: '.$from."\n".$xheads);

/*    $xx = "TO:<b>$to</b> SUBJ:<b>$subject</b> OUTP=<b>$this->output</b> FROM=<b>$from\n</b>$xheads";
    $xx = str_replace("\r","\\r",str_replace("\n","\\n",$xx));
    <textarea cols=120 rows=50>$xx</textarea>"; */
