    ...
    if ($sendit || $resume) {
        ...
        if (!$resume) {
            ...
            if (@mysql_num_rows($prows) > 0) {
                ...
                $sc = time() - $la;
                if ($sc > 22)
                    $sct = " <span style=\"color: darkred; font-weight: bold;\">and seems to be failing</span>";
                elseif ($sc <= 22)
                    $sct = " <span style=\"color: darkgreen; font-weight: bold;\">normally</span>";
                else
                    $sct = '';
